/* @ts-self-types="./table_wasm_engine.d.ts" */
...
export class FormulaEngine {
    ...
    evaluate(formula) {
        ...
        const ret = wasm.formulaengine_evaluate(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
    ...
    evaluate_group(rows, cols, formula, ids) {
        const ptr0 = passStringToWasm0(formula, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.formulaengine_evaluate_group(this.__wbg_ptr, rows, cols, ptr0, len0, ids);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_grid_cols() {
        const ret = wasm.formulaengine_get_grid_cols(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_grid_rows() {
        const ret = wasm.formulaengine_get_grid_rows(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    init_shared_memory(sab, rows, cols) {
        wasm.formulaengine_init_shared_memory(this.__wbg_ptr, sab, rows, cols);
    }
    constructor() {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_get_index_617081a0b226bc8a: function(arg0, arg1) {
            const ret = arg0[arg1 >>> 0];
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./table_wasm_engine_bg.js": import0,
    };
}

const FormulaEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_formulaengine_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('table_wasm_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
